...
\draw[dotted, curved, bend right=40] (ztm1) to node[above] {$q_\bth(\bz_t\mid \bz_{t-1})$}(zt);
\draw[dotted, curved, bend right=40] (zt) to node[below] {$q_\bth(\bz_{t-1}\mid \bz_t)$} (ztm1);
