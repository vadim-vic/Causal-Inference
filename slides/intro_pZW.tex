...
Focus on the causal inference for the model selection in machine learning.
To select a model estimate the distribution of model parameters. PyTorch provides a well-developed automated differentiation framework to estimate the parameters of the model.
\begin{block}{The nearest goal is}
	to propose a method to build Causal Structural Model through the distribution of model parameters and use it for model selection purposes.
\end{block}

\begin{block}{Challenge:}
	How to modify PyTorch autograd so that (after optimization procedure) it returns the causal structure of the model?
\end{block}
...
\end{frame}
%=============================================
\begin{frame}{Causal Chambers\footnote{Nature, 2025: https://www.nature.com/articles/s42256-024-00964-x}}
...
\begin{frame}{Causal Inference and Control Problem}
	\includegraphics[width=0.9\textwidth]{tmp/fig_control_pid}
\end{frame}
%=============================================
\begin{frame}{Conrol problem for time series forecasting\footnote{Nature, 2021: https://www.nature.com/articles/s41467-021-21554-0}}
...
%\end{frame}
%=============================================
\begin{frame}{Testing ideas for Causal Discovery in time series forecasting}
	Driven oscillations: there is a mathematical and statistical model.
	Its phase trajectory in the state space is well-known.
		{\centering{\includegraphics[width=0.6\textwidth]{tmp/fig_wiki_driven_osc}}}
	The latent space contains two variables for the pendulum and two variables for the driving force.
\end{frame}
%=============================================
