...
\secton{Computational experiment}
    For control problem investigale a driven pendulum problem. A pendulum of a given lenth has its own period of oscillation.
    As well it is driven by an external force. A change in the frequency of the driving force leads to composite observations.
    The goal is to identify the causal relationship between the driving force and the pendulum oscillations.
